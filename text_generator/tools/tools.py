...
def create_model_dir(data_dir_name):
    model_dir_path = os.path.join(ROOT_DIR, 'models', data_dir_name)
    _create_dir(model_dir_path)
    checkpoints_dir_path = os.path.join(ROOT_DIR, model_dir_path, 'checkpoints')
...
def write_character_list_in_training_data(character_list_in_training_data, model_dir_path):
    json_path = os.path.join(ROOT_DIR, model_dir_path, 'character_list_in_training_data.json')
